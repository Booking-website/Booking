		...
		<div class="container">
			<form action="./includes/payment.details.inc.php" method="post">
				...
				<table cellpadding="5" class="table payment_table">
					...
					<tr>
						<td class="fix_table"><i aria-hidden="true"></i> Credit Card <input type="radio" name="payment_mode" value="credit card" id="bank_card"></td>
						<td class="fix_table"><i aria-hidden="true"></i> Debit Card <input type="radio" name="payment_mode" value="debit card" id="debit_card"></td>
						<td class="fix_table"><i aria-hidden="true"></i> Net Banking <input type="radio" name="payment_mode" value="net banking" id="net_banking"></td>
					</tr>
				</table>
				<br>
